...
Follow [AGENTS.md](../AGENTS.md), not an overnight-checkpoint process:

- Work only on your assigned branch/worktree.
- Commit completed work; never merge into main.
- Report the commit SHA when finished.
- Before declaring a task complete, verify acceptance criteria, run relevant tests/typecheck/lint/build, and inspect the git diff.
