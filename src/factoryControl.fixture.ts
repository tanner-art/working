...
export const factoryControlFixture: FactoryControlSnapshot = {
  ...
  features: [
    {
      ...
      packages: [
        { id: 'CONTROL-UI', featureId: 'CONTROL-001', title: 'Read-only operations dashboard', priority: 100, lane: 'FEATURE', state: 'ACTIVE', dependencies: [], requiredCapabilities: ['react', 'accessibility'], ownerWorkerId: 'agent-b', currentLease: { id: 'lease-control-ui', workerId: 'agent-b', acquiredAt: '2026-09-24T18:10:00Z', expiresAt: '2026-09-24T19:10:00Z' }, attemptNumber: 1, elapsedRuntimeSeconds: 1200, branch: 'codex/factory-control-center', pullRequestUrl: null, reviewState: null, failureCode: null, blockReason: null, acceptanceCriteria: ['All required views read from one Registry projection.', 'The dashboard remains read-only.'], evidence: [{ id: 'ev-check', kind: 'check', label: 'Contract tests', url: null, recordedAt: '2026-09-24T18:25:00Z' }], attempts: [{ id: 'attempt-control-ui-1', number: 1, workerId: 'agent-b', startedAt: '2026-09-24T18:10:00Z', endedAt: null, outcome: 'active', branch: 'codex/factory-control-center', commitSha: 'c4f2da8cb51c32923cde379660b51186f59674c5', pullRequestUrl: null, evidence: [{ id: 'ev-check', kind: 'check', label: 'Contract tests', url: null, recordedAt: '2026-09-24T18:25:00Z' }] }] },
        { id: 'CONTROL-ASSURANCE', featureId: 'CONTROL-001', title: 'Independent visibility review', priority: 95, lane: 'ASSURANCE', state: 'READY', dependencies: ['CONTROL-UI'], requiredCapabilities: ['review'], ownerWorkerId: null, currentLease: null, attemptNumber: 0, elapsedRuntimeSeconds: 0, branch: null, pullRequestUrl: null, reviewState: 'waiting', failureCode: null, blockReason: null, acceptanceCriteria: ['Implementer is not the sole reviewer.'], evidence: [], attempts: [] },
      ],
    },
    {
  ...
  usageInvocations: [
    { id: 'usage-claude-review', workerId: 'claude', accountLabel: 'approved-claude-account', sessionId: 'session-review-001', packageId: 'SOAK-001-A', attemptId: 'attempt-soak-1', observationClass: 'AUTONOMOUS', observedAt: '2026-09-24T18:01:00Z', modelDiagnostic: 'claude-sonnet-5', inputTokens: 2, outputTokens: 18, cacheReadTokens: 16788, cacheWriteTokens: 23484, durationSeconds: 3.409, outcome: 'SUCCEEDED', limitSignal: null, sources: [{ sourceType: 'CLI_JSON', observedAt: '2026-09-24T18:01:00Z' }, { sourceType: 'TRANSCRIPT', observedAt: '2026-09-24T18:01:02Z' }] },
    { id: 'usage-claude-probe', workerId: 'claude', accountLabel: 'approved-claude-account', sessionId: 'session-probe-001', packageId: null, attemptId: null, observationClass: 'DIAGNOSTIC', observedAt: '2026-09-24T17:30:00Z', modelDiagnostic: 'claude-sonnet-5', inputTokens: 1, outputTokens: 1, cacheReadTokens: 0, cacheWriteTokens: 0, durationSeconds: 1.2, outcome: 'SUCCEEDED', limitSignal: null, sources: [{ sourceType: 'CLI_JSON', observedAt: '2026-09-24T17:30:00Z' }] },
  ],
  events: [
